...
pacman::p_load(metafor, tidyverse, viridis, visreg, forcats, 
               devtools, patchwork, R.rsp, kableExtra, knitr, magrittr, MASS,
               MuMIn)
...
AICc(simple_acute_model, temp_acute_model, trait_acute_model, acute_full, 
    acute_no_age, acute_no_metric, acute_no_org, acute_no_size, acute_no_environment, 
    acute_no_temp, acute_no_flux)

#model with all moderators does best in AIC 
...
#full facet of fluctuation range and mean temp
#ACUTE
