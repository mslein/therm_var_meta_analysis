...
#the excluded data that would allow for comparison across organization level is currently being used for a different project
#if you have questions or are interested in working with data, please contact me: maslein@zoology.ubc.ca
...
vline_age <- dat_ES_final_2 %>%
  ...
  cbind(coef=c(-0.213, 
               ...
               -0.213+ 0.007, 
               -0.213+ -0.071 , 
               -0.213+ -0.071+-0.153+0.117, 
               -0.213+ -0.071+0.007+0.137))
...
pp2_labels <- data.frame(experiment_type=c( "acute", "acclimation"), labels=c("A", "B"))
...
vline_exper <- dat_ES_final_2 %>%
  ...
  summarise(mean=mean(scale_effect), 
            median=median(scale_effect), 
            n=n())%>%
  cbind(coef=c(-0.213, -0.213+ -0.071))

plot_dat$experiment_type_f = factor(plot_dat$experiment_type, levels=c('acute','acclimation'))
...
pp2 <- ggplot()+
  ...
  facet_grid(~factor(experiment_type, levels=c('acute', 'acclimation')), scales = "free_x", space = "free_x")+
...
vline_size <- dat_ES_final_2 %>%
  ...
  cbind(coef=c(-0.213 , 
               ...
               -0.213 +-0.051, 
               -0.213 +-0.071 , 
               -0.213 +-0.071 +-0.296 +0.269 , 
               -0.213 +-0.071 +-0.051 +-0.234))
...
pp4_labels <- data.frame(trait_directional=c("positive", "negative"), labels=c("J", "I"))
...
mean_labels <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("B", "A"))
...
mean_temp<- dat_ES_final_2 %>%
  ...
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(-0.061,-0.061+ 0.057))) +
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))+
  geom_text(data=mean_labels, aes(x=-17, y=2.4,  label=labels), colour="black", size=10)
  


flux_labels <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("D", "C"))
...
flux_range <- dat_ES_final_2 %>%
  ...
  theme(axis.text=element_text(size=20),
        ...
        strip.text = element_text(size = 20))+
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(-0.009,-0.009+0.031))) +
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))+
  geom_text(data=flux_labels, aes(x=-8, y=2.4,  label=labels), colour="black", size=10)



duration_labels <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("H", "G"))
...
duration<- dat_ES_final_2 %>%
  ...
  theme(axis.text=element_text(size=20),
        ...
        strip.text = element_text(size = 20))+
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(-0.047,-0.047))) +
  geom_text(data=duration_labels, aes(x=-0.275, y=2.4,  label=labels), colour="black", size=10)+
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))
  


secondary_labels <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("F", "E"))
...
secondary_temp <- dat_ES_final_2 %>%
  ...
  theme(axis.text=element_text(size=20),
        ...
        strip.text = element_text(size = 20))+
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(0.0001983,0.0001983))) +
...
pp2S <- ggplot()+
  ...
  geom_label(data=vline_exper, aes(x=experiment_type, label=n, y=-5, fill=experiment_type),
             alpha=0.5, size=6)+
  ggtitle("Experiment type")+
  facet_grid(~factor(experiment_type, levels=c('acute', 'acclimation')), scales = "free", space = "free")+
...
########fig s5
mean_labelsS <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("B", "A"))

mean_tempS<- dat_ES_final_2 %>%
  #filter(between(scale_effect, -2.5, 2.5)) %>%
  ggplot(aes(x=I(mean_temp_constant-mean(mean_temp_constant)), y=scale_effect, colour=experiment_type))+
  geom_hline(yintercept = 0, linetype='dashed')+
  geom_point(alpha=0.3, size=2)+
  ...
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(-0.061,-0.061+ 0.057))) +
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))+
  geom_text(data=mean_labelsS, aes(x=-17, y=30,  label=labels), colour="black", size=10)



flux_labelsS <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("D", "C"))


flux_rangeS <- dat_ES_final_2 %>%
  #filter(between(scale_effect, -2.5, 2.5)) %>%
  ggplot(aes(x=I(flux_range-mean(flux_range)), y=scale_effect, colour=experiment_type))+
  geom_hline(yintercept = 0, linetype='dashed')+
  geom_point(alpha=0.3, size=2)+
  ...
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(-0.009,-0.009+0.031))) +
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))+
  geom_text(data=flux_labelsS, aes(x=-8, y=30,  label=labels), colour="black", size=10)



duration_labelsS <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("H", "G"))

durationS<- dat_ES_final_2 %>%
  #filter(between(scale_effect, -2.5, 2.5)) %>%
  ggplot(aes(x=log10(duration_standard), y=scale_effect, colour=experiment_type))+
  geom_hline(yintercept = 0, linetype='dashed')+
  geom_point(alpha=0.3, size=2)+
  ...
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(-0.047,-0.047))) +
  geom_text(data=duration_labelsS, aes(x=-0.275, y=30,  label=labels), colour="black", size=10)+
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))



secondary_labelsS <- data.frame(experiment_type = c("acclimation", "acute"), labels=c("F", "E"))

secondary_tempS <- dat_ES_final_2 %>%
  #filter(between(scale_effect, -2.5, 2.5)) %>%
  ggplot(aes(x=I(secondary_temp-mean(secondary_temp)), y=scale_effect, colour=experiment_type))+
  geom_hline(yintercept = 0, linetype='dashed')+
  geom_point(alpha=0.3, size=2)+
  ...
  geom_abline(aes(intercept=i, slope=s, colour=experiment_type), 
              data=data.frame(experiment_type=c("acute","acclimation"), i=c(-0.213, -0.213 + -0.071), s=c(0.0001983,0.0001983))) +
  geom_text(data=secondary_labelsS, aes(x=-33, y=30,  label=labels), colour="black", size=10)+
  #data=data.frame(experiment_type =c("acute", "acclimation"), y=3.35, x=10, label=c("*")), size=20)+
  facet_wrap(~factor(experiment_type, levels=c('acute', 'acclimation')))


mean_tempS + flux_rangeS +  secondary_tempS + durationS 
...
full_mode$sigma2[1]/sum(full_mode$sigma2[1], full_mode$sigma2[2], full_mode$sigma2[3]) #0.9632517
full_modj$sigma2[1]/sum(full_modj$sigma2[1], full_modj$sigma2[2], full_modj$sigma2[3]) #0.9574689
#study level heterogeneity
full_mode$sigma2[2]/sum(full_mode$sigma2[1], full_mode$sigma2[2], full_mode$sigma2[3]) #0.01278635
full_modj$sigma2[2]/sum(full_modj$sigma2[1], full_modj$sigma2[2], full_modj$sigma2[3]) #0.01678004
#response heterogeneity 
full_mode$sigma2[3]/sum(full_mode$sigma2[1], full_mode$sigma2[2], full_mode$sigma2[3]) #0.02396194
full_modj$sigma2[3]/sum(full_modj$sigma2[1], full_modj$sigma2[2], full_modj$sigma2[3]) #0.0257511

#calculating fail safe number
fsn(yi, vi, data=dat_ES_final_2,type="Rosenberg") #260819
